...
tr = PorterStemmer()
parser = ParserCACM()
index = Index("test", parser, tr, "/home/gozuslayer/DAC/DAC/RI/TP1-6/RI/cacm/")
index.indexation("/home/gozuslayer/DAC/DAC/RI/TP1-6/RI/cacm/cacm.txt")
rep = index.getTfsForDoc('99')
text = index.getStrDoc('46')
