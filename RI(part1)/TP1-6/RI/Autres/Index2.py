...
class Index():
	...
	def getTfsForStem(self, stem):
		...
		index_file_inverse.seek(index_inverse[stem][0])
...
tr = PorterStemmer()
parser = ParserCACM()
index_cacm = Index("cacm", parser, tr, "/home/gozuslayer/DAC/DAC/RI/TP1-6/RI/cacm/")
index_cacm.indexation("/home/gozuslayer/DAC/DAC/RI/TP1-6/RI/cacm/cacm.txt")
